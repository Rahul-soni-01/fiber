                        ...
                        <div class="row custom-row mt-2 g-2 align-items-center">
                            <div class="col">
                                <select required id="serial_no" class="form-control " name="serial_no[]"
                                    ...
                                    <option value="{{ $serial_no->id }}" @if($item->report->sr_no_fiber == $serial_no->sr_no_fiber) selected @endif>{{ $serial_no->sr_no_fiber }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col">
                                
                                <input type="text" id="final_price" value="{{ $item->report->final_amount ?? 'N/A' }}" name="total_amount" class="form-control" readonly>
                            </div>
                            <div class="col">
