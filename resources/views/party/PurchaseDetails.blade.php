<x-layout>
    <x-slot name="title">Supplier Purchase Payment Details</x-slot>
    <x-slot name="main">
        <div class="main" id="main">
            ...
            <ul class="nav nav-tabs" id="supplierTab" role="tablist">
                ...
                <li class="nav-item ml-5" role="presentation">
                  <a class="nav-link active" id="supplier-payment-tab" data-bs-toggle="tab" href="#supplier-payment" role="tab" aria-controls="supplier-payment" aria-selected="true">Supplier Payment</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="supplier-history-tab" data-bs-toggle="tab" href="#supplier-history" role="tab" aria-controls="supplier-history" aria-selected="false">Supplier Purchase</a>
                </li>
            </ul>
              ...
              <div class="tab-content" id="supplierTabContent">
                ...
                <div class="tab-pane fade show active" id="supplier-payment" role="tabpanel" aria-labelledby="supplier-payment-tab">
                    ...
                    <div class="d-flex justify-content-center align-items-center"> <h5>Payment Details </h5></div>
