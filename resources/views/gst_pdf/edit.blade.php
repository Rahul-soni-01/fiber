              ...
              <form action="{{ route('gst-pdf.update', $gstPdfRecord->id) }}" method="POST">
                ...
                <div id="item-container">
                    <div class="border row mt-3">
                        ...
                        <div class="col-6 col-sm-6 col-md-2"> <strong> Price </strong></div>

                        <div class="col-6 col-sm-6 col-md-2"> <strong> Total(T) </strong> <button type="button" onclick="items_add()"
                ...
                <div class="row mt-2">
                    ...
                    <div class="col col-sm-6 col-md-4"> <input type="number" id="sgst_amt" name="sgst_amt" value="{{ $gstPdfRecord->sgst_amt }}" placeholder="Enter CGST Amt." class="form-control form-control-sm"></div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col col-sm-6 col-md-4 border-right d-flex align-items-center">@
