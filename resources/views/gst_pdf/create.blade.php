    ...
    <form action="{{route('gst-pdf.store')}}" method="post">
        ...
        <div id="item-container">
            ...
            <div class="row border input-row mt-2">
                ...
                <div class="col border-right">
                    <input type="number" class="form-control qty w-75" placeholder="Qty" name="qty[]"
                ...
                <div class="col border-right">
                    <input type="number" step="0.01" class="form-control price w-75" placeholder="Price"
        ...
        <div class="row mt-2">
            ...
            <div class="col"> <input type="number" id="cgst_amt" name="cgst_amt" placeholder="Enter CGST Amt."
                    class="form-control form-control-sm">
            </div>
        </div>
        <div class="row mt-2">
            ...
            <div class="col"> <input type="number" id="sgst_amt" name="sgst_amt" placeholder="Enter CGST Amt."
