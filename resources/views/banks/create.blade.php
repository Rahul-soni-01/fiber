                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="account_holder_name" id="account_holder_name" class="form-control"
                            value="{{ old('account_holder_name') }}" required placeholder="Enter Account Holder Name">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="opening_balance" id="opening_balance" class="form-control"
                            value="{{ old('opening_balance') }}" required placeholder="Enter Account Opening Blanace">
                    </div>
