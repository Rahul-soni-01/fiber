...
<div class="main">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col">
                            <b class="text-info">{{ $supplier['total_inr_amount'] }}</b>
                        </div>
                        <div class="col">
                            <button class="btn btn-sm d-flex justify-content-center btn-secondary text-dark"> <a
                                    href="{{ route('party.purchase.details', ['party_id' => $supplier['party_id'] ]) }}">
                                    <i class="ri-eye-fill"></i> </a></button>
                        </div>
                    </div>
                    {{-- <button class="btn btn toggle-btn float-right" data-target="purchases-{{ $index }}">
                        <i class="bi bi-chevron-right"></i> Show
                    </button>
                    <table class="datatable-remove table table-sm table-striped mt-2 nested-table"
                        id="purchases-{{ $index }}" style="display: none;">
                        <thead>
                            <tr>
                                <th>Purchase ID</th>
                                <th>Date</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a
                                        href="{{ route('show_item.details', ['invoice_no' => $purchase['invoice_no']]) }}"><i
                ...
                <td>
                    <div class="row">
                        <div class="col">
                            <b class="text-success">{{ $supplier['total_inr_payments'] }} </b>
                        </div>
                        {{-- <button class="btn btn toggle-btn float-right" data-target="payments-{{ $index }}">
                            <i class="bi bi-chevron-right"></i> Show
                        </button>
                        <table class="datatable-remove table table-sm table-striped mt-2 nested-table"
                            id="payments-{{ $index }}" style="display: none;">
                            <thead>
                                <tr>
                                    <th>Payment ID</th>
                                    <th>Amount Paid</th>
                        ...
                        <div class="col">
                            <a class="btn btn-light float-right text-dark"
                                href="{{ route('party.purchase.details', ['party_id' =>  $supplier['party_id'] ]) }}?payment">
                                Supplier Payment </a>
                        </div>
                    </div>
                </td>
    ...
    {{-- <div class="d-flex justify-content-center align-items-center">
        <h5>Supplier Payment Details </h5>
    </div>
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('payment.edit', ['payment_id' => $payment->id]) }}"><i
