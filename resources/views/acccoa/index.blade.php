    ...
    <table class="table ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ route('acccoa.edit', ['acccoa_id' => $account->id]) }}" class="btn btn-sm btn-warning"><i  class="ri-pencil-fill"></i></a>
                    <form action="{{ route('acccoa.destroy', $account->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE') <!-- Specify the method as DELETE -->
                        <button type="submit" onclick="return confirm('Are you sure you want to delete this account?');" class="btn btn-sm btn-danger"> <i class="ri-delete-bin-fill"></i></button>
                    </form>
                </td>
            </tr>
            @endforeach
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row text-dark"  style="background-color: #ececec;">
