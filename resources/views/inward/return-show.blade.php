<x-layout>
    ...
    <x-slot name="main">
        ...
        <a href="{{ route('generate-pdf', ['purchase_return' => $id]) }}" class="btn btn-primary mb-3" id="download-btn1212">Download PDF</a>
      
        <div class="container">
            <div class="row">
                <div class="col"><h4>Invoice No.</h4></div>
                <div class="col"><h4>Party Name</h4></div>
