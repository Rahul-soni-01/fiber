...
<!-- DataTables JS -->
    ...
    <div class="main" id="main">
            ...
            <div class="row">
                ...
                <div class="col"><input type="text" id="amount_inr" name="amount_inr" placeholder="Amount (₹)" class="form-control"></div>
                <div class="col"><form method="post"><button type="submit" class="btn btn-dark" id="search" name="search">Search</button></form></div>
            </div>
            </form>
                ...
                <tbody>
                    ...
                    @foreach ($inwards as $inward)
                        <tr>
                            ...
                            <td><a href="{{ route('show_item.details', ['invoice_no' => $inward['invoice_no']]) }}"><i class="ri-eye-fill"></i></a> </td>
