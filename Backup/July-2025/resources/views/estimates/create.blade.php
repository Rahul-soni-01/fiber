    ...
    <form action="{{ route('estimates.store') }}" method="POST">
      ...
      <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="sr_no" id="sr_no" class="form-control" value="{{ old('sr_no') }}" placeholder="Enter Serial Number">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="cid" id="cid" class="form-control" value="{{ old('cid') }}" placeholder="Customer Name">
            </div>
        </div>
