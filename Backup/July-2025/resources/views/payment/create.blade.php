            ...
            <form action="{{ route('payment.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <select id="supplier_select" name="sid" class="form-control" placeholder="Enter Party Name"
                            required onchange="filterInvoices();">
                    ...
                    <div id="supplier_bank_details" class="mt-3 col-md-12" style="display: none;">
                        <div class="row">
                            <div class="mb-3 col-md-4 text-dark">
                    ...
                    <button type="submit" class="btn btn-success float-right w-auto">Submit</button>
            </form>
        </div>
    </div>
    </div>
