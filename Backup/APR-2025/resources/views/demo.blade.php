                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item" id="Report">
                        ...
                        <div class="collapse" id="reportMenu">
                            <ul class="nav flex-column ms-3">
                                ...
                                <li class="nav-item nav-sub-item" id="view">
                                    <a href="{{ route('invoices.index') }}" id="view" class="nav-link">Select Invoice</a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- Sale -->
                    ...
                    <li class="nav-item" id="Section">
                        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#SectionMenu">
                            <i class="fa-solid fa-puzzle-piece"></i> Section <i class="ri-arrow-down-s-line float-end"></i>
                        </a>
