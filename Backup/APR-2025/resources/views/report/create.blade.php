    ...
    <table class="table table-bordered custom-border datatable-remove" id="tbl">
        <tbody id="Tbody">
            ...
            <tr>
                ...
                <td><input type="text" id="ampled" name="sr_cardamp[]" class="form-control" placeholder="Enter AMP">
                </td>
                <td><input type="text" id="voltled" name="sr_cardvolt[]" class="form-control" placeholder="Enter Volt">
                </td>
        ...
        <tr>
            <td class="d-flex ">
                <h5>LED</h5>
                <select required onchange="tbl_stock(0);" id="subcategory_0" class="tbl_sub ml-2 form-control"
                    name="sub_category[]">
                    <option value="" selected disabled>Select</option>
        ...
        <tr>
            ...
            <td><input type="text" id="ampaomqswitch" name="amp_aom_qswitch" class="form-control"
                    placeholder="Enter AMP"></td>
            <td><input type="text" id="voltaomqswitch" name="volt_aom_qswitch" class="form-control"
                    placeholder="Enter Volt"></td>
            <td><input type="text" id="wattaomqswitch" name="watt_aom_qswitch" class="form-control"
                    placeholder="Enter Watt"></td>
        </tr>
        @endif
